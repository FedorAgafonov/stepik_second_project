...
db.session.query(Teachers).filter(Teachers.id > 12).delete()
db.session.query(Times).filter(Teachers.id > 8).delete()
db.session.query(Day).filter(Teachers.id > 7).delete()
db.session.commit()
#
